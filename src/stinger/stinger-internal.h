...
struct stinger_vb
{
  int64_t vtype;      /**< Vertex type */
  int64_t weight;     /**< Vertex weight */
  int64_t inDegree;   /**< In-degree of the vertex */
  int64_t outDegree;  /**< Out-degree of the vertex */
  eb_index_t edges;  /**< Pointer to the first edge block of this vertex */
};
